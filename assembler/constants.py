...
MIN_ANCHOR_LENGTH = 100   # this shouldn't be more than avg read length. For example, this length won't work for HiFi
...
READS_DEPTH_HETEROZYGOUS = 0
SNARL_DEPTH_HETEROZYGOUS = 0
READS_DEPTH_HOMOZYGOUS = 0
MIN_ANCHOR_READS = 0
