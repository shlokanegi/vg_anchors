...
class Orchestrator:
    ...
    def dump_anchors(self, out_file: str, extended_out_file: str, anchor_read_tracking_file_path: str, independent_anchor_read_tracking_file_path: str):
        """
        It dumps the anchors by json
        """
        self.alignment_processor.dump_valid_anchors(out_file, extended_out_file, anchor_read_tracking_file_path, independent_anchor_read_tracking_file_path)
