...
class AlignAnchor:
    ...
    def verify_path_concordance(
        ...
        nodes_al_range = alignment_node_id_list[alignment_range[0]: alignment_range[1]]
        orientation_al_range = alignment_orientation_list[alignment_range[0]: alignment_range[1]]
